...
| - Perform differential expression analysis for ribosome profiling and bulk RNA-Seq data
| - Perform transcript meta-analyeis, including ribosome profiling periodicity analysis, and library complexity analysis
